        ...
        <div id="innercontainer">
            <div id="left">
                <div class="list">
                    ...
                    <a class="active" href="about_workandedu.php">Work And Education</a>
            ...
            <div id="right">
                ...
                <p style="color:grey;"><i class="fa fa-twitter" style="color:#00BFFF"></i>&nbsp;&nbsp;Studies in {{user_data.university}}</p>
            </div>
        </div>
    </div>
    <?php
